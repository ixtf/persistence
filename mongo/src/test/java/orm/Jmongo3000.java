...
public class Jmongo3000 extends JmongoOptions {
    ...
    public static void main(String[] args) {
        final Constructor<Jmongo3000> declaredConstructor = Jmongo3000.class.getDeclaredConstructor();
        final Jmongo3000 jmongo3000 = declaredConstructor.newInstance();
        System.out.println(jmongo3000);
    }
}
